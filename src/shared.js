...
export function populateRegionSelect(selectElement) {
  ...
  // Add "High Seas" option after World
  const highSeasOption = document.createElement('option');
  highSeasOption.value = 'XX';
  highSeasOption.textContent = chrome.i18n.getMessage('regionHighSeas') || 'High Seas';
  selectElement.appendChild(highSeasOption);
  ...
  REGIONS.forEach(region => {
    ...
    // Get localized country name via Intl.DisplayNames
    try {
